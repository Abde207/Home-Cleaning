...
@Module({
  imports: [
    ...
    DatabaseModule, RedisModule, AuthModule, CoreModule, BookingModule, PricingModule, DispatchModule, PaymentModule, NotificationModule, ProviderAssignmentsModule, AdminReadModelsModule, AdminFinanceModule, AdminObservabilityModule,
  ],
